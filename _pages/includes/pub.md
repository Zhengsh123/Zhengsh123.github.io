 ...
 * @LastEditTime: 2023-10-10 22:07:47
 * @Description: 
 * 
-->
...
- ``EMNLP 2023`` [Through the Lens of Core Competency: Survey on Evaluation of Large Language Models](https://xxx), Ziyu Zhuang, **Qiguang Chen**, Longxuan Ma, Mingda Li, Yi Han, Yushan Qian, Haopeng Bai, Weinan Zhang, Ting Liu.
...
- ``EMNLP 2022 MMNLU Best Paper`` [CGIM: A Cycle Guided Interactive Learning Model for Consistency Identification in Task-oriented Dialogue](https://aclanthology.org/2022.mmnlu-1.4.pdf), Libo Qin, **Qiguang Chen**, Tianbao Xie, Qian Liu, Shijue Huang, Wanxiang Che, Zhou Yu.
